...
$modifierlink = 'http://wiki.dragon-blade.jp/';
...
// Default: always fail
$adminpass = '{x-php-md5}' . md5('Click123');
...
$auth_users = array(
	// Username => password
	'ClickTech' => 'click123',  //追加ユーザー
	'Admin' => 'click123',  //追加ユーザー
	'chen' => '123',  //追加ユーザー
