...
<td valign=top>
	<span id=rgn_button$this->callcount style="cursor:pointer;font:normal 14px ＭＳ Ｐゴシック;border:gray 0px solid;"
	onclick="
...
EOD;
	...
	function buildBracketHtml(){
		...
		return <<<EOD
<td id=rgn_bracket$this->callcount style="font-size:12pt;border:black 0px;$bracketstyle">&nbsp;</td>
EOD;
	}
	...
	function buildSummaryHtml(){
		...
		return <<<EOD
<td id=rgn_summary$this->callcount style="width:100px;font-size:12pt;color:black;border:black 0px solid;$summarystyle">$this->description</td>
EOD;
	}
	...
	function buildContentHtml(){
		...
		return <<<EOD
<td valign=top id=rgn_content$this->callcount style="width:100px;font-size:12pt;color:black;border:black 0px solid;$contentstyle">
EOD;
	}
